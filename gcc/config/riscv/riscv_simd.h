...
CREATE_RVP_INTRINSIC(int32_t, sshar, int32_t, int32_t)
...
CREATE_RVP_INTRINSIC(int64_t, padd_dbs, int64_t)
CREATE_RVP_INTRINSIC(int64_t, padd_dhs, int64_t)
CREATE_RVP_INTRINSIC(int64_t, padd_dws, int64_t)
