...
(define_insn "riscv_psaddu_<SUFFIX>_<VQIHISI:mode>_p"
  [(set (match_operand:VQIHISI 0 "register_operand" "=r")
        (unspec:VQIHISI [(match_operand:VQIHISI 1 "register_operand" "r")
                    (match_operand:VQIHISI 2 "register_operand" "r")]
         UNSPEC_PSRA))]
...
(define_insn "riscv_paaddu_<SUFFIX>_<VQIHISI:mode>_p"
  [(set (match_operand:VQIHISI 0 "register_operand" "=r")
        (unspec:VQIHISI [(match_operand:VQIHISI 1 "register_operand" "r")
                    (match_operand:VQIHISI 2 "register_operand" "r")]
         UNSPEC_PSRA))]
...
(define_insn "riscv_pas_hx_<mode>_p"
  [(set (match_operand:VHI 0 "register_operand"              "=r")
	(unspec:VHI [(match_operand:VHI 1 "register_operand"   " r")
		     (match_operand:VHI 2 "register_operand" " r")] UNSPEC_PAS))]
  "TARGET_RVP"
  "pas.hx\t%0,%1,%2"
  [(set_attr "type" "simd")
   (set_attr "mode" "<MODE>")])
...
(define_insn "riscv_psa_hx_<mode>_p"
  [(set (match_operand:VHI 0 "register_operand"              "=r")
	(unspec:VHI [(match_operand:VHI 1 "register_operand"   " r")
		     (match_operand:VHI 2 "register_operand" " r")] UNSPEC_PSA))]
  "TARGET_RVP"
  "psa.hx\t%0,%1,%2"
  [(set_attr "type" "simd")
   (set_attr "mode" "<MODE>")])
